...
- `.gemini/docs/git-workflow.md` — Conventions de commits et branches
...
Écris les tests en suivant `.gemini/docs/testing-strategy.md` :
...
- Propose le message de commit conforme à `.gemini/docs/git-workflow.md` :
  - Format : `type(scope): description courte [gemini/dev]`
