...
- `.gemini/docs/architectures/layered/back.md` — Contraintes architecture back-end
- `.gemini/docs/architectures/layered/front.md` — Contraintes architecture front-end
- `.gemini/docs/models/anemic.md` — Méthodologie entités métier (modèle anémique)
- `.gemini/docs/testing-strategy.md` — Stratégie de tests par couche
...
1. **Entités métier** — En suivant pas à pas la méthodologie de `.gemini/docs/models/anemic.md`
...
- Faire la sélection de stack inline en suivant `.gemini/docs/stack-selection.md`
...
- Suis la méthodologie de `.gemini/docs/models/anemic.md` étape par étape, sans sauter d'étape.
